...
template class Matrix<Vector,double,3>;
template class Matrix<Vector,Liczba,5>;
template class System<Matrix,Vector,double,3>;
...
template std::ostream & operator << (std::ostream & o, const Matrix<Vector,double,3>& v);
template std::ostream & operator << (std::ostream & o, const Matrix<Vector,Liczba,5>& v);
template std::ostream & operator << (std::ostream & o, const System<Matrix,Vector,double,3> & u);
...
template std::istream & operator >> (std::istream & i, Matrix<Vector,double,3> & v);
template std::istream & operator >> (std::istream & i, Matrix<Vector,Liczba,5> & v);
template std::istream & operator >> (std::istream & i, System<Matrix,Vector,double,3> & u);
